                          ...
                          <tbody>
                            <tr>
                              <td bgcolor="#ffffff" style="padding:35px 30px 25px">
                                ...
                                <p style="color:#445361;font-family:'Trebuchet MS',Arial,sans-serif;font-size:14px;line-height:24px;margin:0 0 25px;Margin:0 0 25px">You are receiving this email because we received a password reset request for your account.<br/> Your new password is <strong>{{$password}}</strong></p>                  
